...
public interface LeadStageHandler {
    ...
    LeadStageExecutionResult executeAction(LeadStageAction action, LeadStageContext context);
    ...
    default Set<String> supportedDatatableNames(StageConfiguration configuration) {
        return Set.of();
    }

    default List<LeadStageDocumentRequirement> documentRequirements(LeadStageContext context) {
        return List.of();
    }
}
