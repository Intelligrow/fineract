...
@Entity
@NoArgsConstructor
@Table(name = "m_lead_stage_action_history")
public class LeadStageActionHistory extends AbstractAuditableWithUTCDateTimeCustom<Long> {
    ...
    private LeadStageAction action;
